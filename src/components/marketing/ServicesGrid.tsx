        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className={`group relative p-7 md:p-10 rounded-[30px] md:rounded-[40px] bg-[#080808] border border-white/10 overflow-hidden ${service.className} transition-all duration-500`}
            >
              {/* Efectos visuales */}
